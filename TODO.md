...
- `[x]` **D4-B4 — Console ledger view** — *live `/admin/economics` data renders spend, regret, rework and net value; unmeasured values are labelled rather than shown as zero.*
