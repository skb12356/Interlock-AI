...
- `[~]` **D4-B4 — Console ledger view** — *live `/admin/economics` data renders spend, regret, rework and net value; unmeasured values are labelled rather than shown as zero. The current ledger endpoint does not yet provide a confidence interval for running net or render a CI band.*
